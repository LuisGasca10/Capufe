...
const Trabajador = ({ navigation }) => {
    return (
        <View style={styles.contenedorPrin}>
            ...
            <Boton text="Log in" onPress={() => { navigation.navigate('loginTrabajador2') }} />

            <View style={styles.contenorTxtSign}>
                <Text style={styles.text}>Don´t have an account?</Text>
                <Pressable onPress={() => navigation.navigate('signTrabjador')}><Text style={styles.textSign}> Sign</Text></Pressable>
            </View>
